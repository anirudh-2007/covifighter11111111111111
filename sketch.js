...
blast_Sound = loadSound("blast_sound.mp4");
  ...
  celebration_Sound = loadSound("celebration_Sound.mp4");

  End_Image = loadImage("End_Image.jpeg");
}
function setup() {
  ...
  greenLine = createSprite(windowWidth-1200 ,windowHeight-450,20,1200);
  greenLine.addImage(cheakpoint_Image);
  greenLine.scale = 0.45;

  cp = createSprite(windowWidth-1200 ,windowHeight-450,20,1200);
  cp.addImage(cp_image);
  cp.scale = 0.45;

  goodperson1 = createSprite(windowWidth+100 ,windowHeight-662,30,70);
  goodperson1.addAnimation("gd" ,goodperson_Image);
  goodperson1.scale = 0.3;

 

  goodperson2 = createSprite(windowWidth+100 ,windowHeight-412,30,70);
  goodperson2.addAnimation("gd" ,goodperson_Image);
  goodperson2.scale = 0.3;


  goodperson3 = createSprite(windowWidth+100 ,windowHeight-162,30,70);
  goodperson3.addAnimation("gd" ,goodperson_Image);
  goodperson3.scale = 0.3;

  
  goodperson4 = createSprite(windowWidth+100 ,windowHeight-162,30,70);
  goodperson4.addAnimation("gd" ,goodperson_Image);
  goodperson4.scale = 0.3;

  
  goodperson5 = createSprite(windowWidth+100 ,windowHeight-662,30,70);
  goodperson5.addAnimation("gd" ,goodperson_Image);
  goodperson5.scale = 0.3;

 
  goodperson6 = createSprite(windowWidth+100 ,windowHeight-412,30,70);
  goodperson6.addAnimation("gd" ,goodperson_Image);
  goodperson6.scale = 0.3;

  covid_ball1 = createSprite(windowWidth+100 ,windowHeight-662,30,70);
  covid_ball1.addImage(covid_ball_Image);
  covid_ball1.scale = 0.5;



  covid_ball2 = createSprite(windowWidth+100,windowHeight-412,30,70);
  covid_ball2.addImage(covid_ball_Image);
  covid_ball2.scale = 0.5;

  
  covid_ball3 = createSprite(windowWidth+100 ,windowHeight-162,30,70);
  ...
  badperson1 = createSprite(windowWidth+100 ,windowHeight-662,30,70);
  badperson1.addAnimation("bad_person" ,badperson_Image);
  badperson1.scale = 0.3;

 
  badperson2 = createSprite(windowWidth+100 ,windowHeight-412,30,70);
  badperson2.addAnimation("bad_person" ,badperson_Image);
  badperson2.scale = 0.3;


  badperson3 = createSprite(windowWidth+100 ,windowHeight-162,30,70);
  ...
  cov = createSprite(windowWidth-890 ,windowHeight-460);
  cov.addImage(covidFighters_Image);
  cov.scale = 1.2;

  covifighter = createSprite(windowWidth-650,windowHeight-780);
  covifighter.addImage(covifighter_Image);
  covifighter.scale =1;

 

   plays = createSprite(windowWidth-650,windowHeight-550)
   plays.addImage(p1_Image);
   plays.scale = 0.65;

   htp = createSprite(windowWidth-650,windowHeight-350)
   htp.addImage(htp_Image);
   htp.scale = 0.65;

   pwm = createSprite(windowWidth-650,windowHeight-150);
   pwm.addImage(pwm_1);
   pwm.scale = 1;

   mask = createSprite(windowWidth-1200,windowHeight-150);
   mask.addImage(mask_Image);
   mask.scale = 1.25;

   ul1 = createSprite(windowWidth-1320,windowHeight-550);
   ul1.addImage(ul1_Image);
   ul1.scale = 1.75;
   ul1.visible = false;
   
   ll2 = createSprite(windowWidth-1020,windowHeight-350);
   ll2.addImage(ll2_Image);
   ll2.scale = 0.65;
   ll2.visible = false;

   ll3 = createSprite(windowWidth-720,windowHeight-550);
   ll3.addImage(ll3_Image);
   ll3.scale = 0.65;
   ll3.visible = false;
   
   ll4 = createSprite(windowWidth-420,windowHeight-350);
   ll4.addImage(ll4_Image);
   ll4.scale = 0.65;
   ll4.visible = false;

   ll5 = createSprite(windowWidth-100,windowHeight-550);
   ll5.addImage(ll5_Image);
   ll5.scale = 0.65;
   ll5.visible = false;


   back = createSprite(windowWidth-14600,windowHeight-790);
   ...
   back2 = createSprite(windowWidth-1460,windowHeight-690);
   back2.addImage(back_Image);
   back2.scale = 0.3;
   back2.visible = false;


   htps = createSprite(windowWidth-700,windowHeight-350);
   htps.addImage(htps_Image);
   htps.scale = 0.1;
   htps.visible = false;


  level1_target = createSprite(windowWidth-350,windowHeight-830);
  level1_target.addImage(level1target_Image);
  level1_target.scale = 0.35;
  level1_target.visible = false;

  
  type_level = createSprite(windowWidth-1050,windowHeight-830);
...
ground1 = new Ground(windowWidth-820,windowHeight-550,3200,20);
ground2 = new Ground(windowWidth-820,windowHeight-300,3200,20);
ground3 = new Ground(windowWidth-820,windowHeight-50,3200,20);



bow = new Bow(windowWidth-1320,windowHeight-415,200,220);




tick_mark1 = createSprite(windowWidth-1320,windowHeight-545);
...
covn1 = createSprite(windowWidth+100 ,windowHeight-662,30,70);
covn1.addImage(covn1_Image);
covn1.scale = 0.75;
covn1.visible = false;


covn2 = createSprite(windowWidth+100 ,windowHeight-412,30,70);
covn2.addImage(covn2_Image);
covn2.scale = 0.7;
covn2.visible = false;


covn3 = createSprite(windowWidth+100 ,windowHeight-162,30,70);
covn3.addImage(covn3_Image);
covn3.scale = 0.75;
covn3.visible = false;


covn4 = createSprite(windowWidth+100 ,windowHeight-412,30,70);
covn4.addImage(covn4_Image);
covn4.scale = 0.75;
covn4.visible = false;


covn5 = createSprite(windowWidth+100 ,windowHeight-162,30,70);
covn5.addImage(covn5_Image);
covn5.scale = 0.75;
covn5.visible = false;


t1 = createSprite(windowWidth-1400,windowHeight-780,30,70);
t1.addImage(tz);
t1.scale = 0.75;
t1.visible = false;


t2 = createSprite(windowWidth-1325,windowHeight-780,30,70);
t2.addImage(tz);
t2.scale = 0.75;
t2.visible = false;


t3 = createSprite(windowWidth-1250,windowHeight-780,30,70);
t3.addImage(tz);
t3.scale = 0.75;
t3.visible = false;


t4 = createSprite(windowWidth-1400,windowHeight-640,30,70);
t4.addImage(tz);
t4.scale = 0.75;
t4.visible = false;


t5 = createSprite(windowWidth-1325,windowHeight-640,30,70);
t5.addImage(tz);
t5.scale = 0.75;
t5.visible = false;

t6 = createSprite(windowWidth-1250,windowHeight-640,30,70);
t6.addImage(tz);
t6.scale = 0.75;
t6.visible = false;


End_Slogan = createSprite(windowWidth-690,windowHeight-460);
End_Slogan.addImage(End_Image);
End_Slogan.scale = 0.32;
End_Slogan.visible = false;
...
goodperson1.x = windowWidth-2000;
gpr_Sound.play();
t1.visible = true;
  ...
  if(goodperson2.isTouching(greenLine)   ){
    //goodperson2.x = windowWidth;
    goodperson2.x = windowWidth-2000;
    gpr_Sound.play();
    t2.visible = true;
      }

      if(goodperson3.isTouching(greenLine)   ){
      //  goodperson3.x = windowWidth;
        goodperson3.x = windowWidth-2000;
        gpr_Sound.play();
        t3.visible = true;
        }
        ...
        if(goodperson4.isTouching(greenLine)   ){
          //  goodperson3.x = windowWidth;
            goodperson4.x = windowWidth-2000;
            gpr_Sound.play();
            }
          ...
          if(badperson1.isTouching(greenLine) ||badperson2.isTouching(greenLine)  ||badperson3.isTouching(greenLine)  ){
            badperson1.x = windowWidth+100;
            badperson2.x = windowWidth+100;
            badperson3.x = windowWidth+100;
  ...
  goodperson1.x=  windowWidth+100;
  goodperson2.x = windowWidth+100;
  goodperson3.x = windowWidth+100;
  goodperson4.x = windowWidth+100;
  badperson1.x =windowWidth+100;
  badperson2.x =windowWidth+100;
  badperson3.x = windowWidth+100;

  ul1.visible = true;
  ul1.x = windowWidth-1320;
  ll2.visible = true;
  ll3.visible = true;
  ll4.visible = true;
  ll5.visible = true;
  ...
  covifighter.addImage(covifighter_Image);
  covifighter.scale = 1;
  covifighter.y = windowHeight-750;

  back.visible = false;
  back.y = windowHeight-8180;
  back.x = windowWidth-14800;
  back2.y = windowHeight-690;
  back2.visible = true;
  cov.visible = true;
                }
...
if(mousePressedOver(plays) || touches.length>0){

  
  touches = [];
  plays.x = windowWidth+14000;
  htp.x = windowWidth+14000;
 
 
  pwm.x = windowWidth-700;
  pwm.scale = 1.2;
  mask.visible = false;
  ul1.visible = true;
  ll2.visible = true;
...
if(mousePressedOver(back2) || touches.length>0){
  touches = [];
  plays.x = windowWidth-650
  htp.x = windowWidth-650
 
  
  pwm.x = windowWidth-650;
  pwm.scale = 1;
...
if(mousePressedOver(ul1) || touches.length>0){
  touches = [];
  swal(
    {
...
// level1_target.visible = true;
 ...
 covifighter.visible = false;
  back.visible = true;
  back.scale = 0.175;
  back.y = windowHeight-818;
  back.x = windowWidth-1480;
  mask.visible = false
  cov.visible = false;
  back2.y = windowWidth+10000;
...
if(mousePressedOver(htp) || touches.length>0){
  ...
  mask.visible = false;
  htps.scale = 1;
  htps.y = windowHeight-500;
  plays.x = windowWidth-10000000000000;
  htp.x = windowWidth-1000000;
  //goodperson.destroy();
  pwm.x = windowWidth-750;
...
if(goodperson1.x<windowWidth-1500 && goodperson2.x<windowWidth-1500 && goodperson3.x<windowWidth-1500)
gameState = END1;
            ...
            //  goodperson3.x = windowWidth;
              ...
              if(goodperson4.isTouching(greenLine)   ){
                ...
                if(badperson1.isTouching(greenLine)||badperson2.isTouching(greenLine) || badperson3.isTouching(greenLine) ||covid_ball1.isTouching(greenLine) ||covid_ball2.isTouching(greenLine)  ||covid_ball3.isTouching(greenLine)    ){
                  ...
                  badperson2.x =  windowWidth+100;
                  badperson3.x =  windowWidth+100;
                  covid_ball1.x =  windowWidth+100;
                  covid_ball2.x =  windowWidth+100;
                  covid_ball3.x =  windowWidth+100;
                  goodperson1.velocityX = 0;
                  goodperson2.velocityX = 0;
                  goodperson3.velocityX = 0;
                  goodperson4.velocityX = 0;
...
if(mousePressedOver(back2) || touches.length>0){
  ...
  htps.visible = false;
      ...
      if(mousePressedOver(ll2)|| touches.length>0){
 ...
 back2.visible = true;
      ...
      if(goodperson1.x<windowWidth-1500 && goodperson2.x<windowWidth-1500 && goodperson3.x<windowWidth-1500 &&  goodperson4.x<windowWidth-1500)
      gameState = END2;
...
if(gameState === PLAY3){
  ...
  if(mousePressedOver(ll3)||touches.length>0){
    touches = [];
    swal(
      {
...
if(gameState === PLAY4){
  ...
  if(goodperson1.isTouching(greenLine)   ){
    ...
    t1.visible = true;
            ...
            if(goodperson4.isTouching(greenLine)   ){
              //  goodperson3.x = windowWidth;
                ...
                if(goodperson5.isTouching(greenLine)   ){
                  //  goodperson3.x = windowWidth;
                    goodperson5.x = windowWidth-2000;
                    gpr_Sound.play();
                    t5.visible = true;
                    }
      ...
      goodperson3.x = windowWidth+100;
      goodperson4.x = windowWidth+100;
      goodperson5.x = windowWidth+100;
      badperson1.x = windowWidth+100;
      badperson2.x = windowWidth+100;
      badperson3.x = windowWidth+100;
      covn1.x = windowWidth+100;
      covn2.x = windowWidth+100;
      covn3.x = windowWidth+100;
      covn4.x = windowWidth+100;
      covn5.x = windowWidth+100;
  ...
  if(mousePressedOver(ll4) || touches.length>0){
    touches = [];
    swal(
      {
 ...
 back2.visible = true;
  ...
  if(goodperson1.x<windowWidth-1500 && goodperson2.x<windowWidth-1500 && goodperson3.x<windowWidth-1500 &&  goodperson4.x<windowWidth-1500 && goodperson5.x<windowWidth-1500 )
  gameState = END4;
}
...
if(gameState ===PLAY5){
                ...
                if(goodperson5.isTouching(greenLine)   ){
                  //  goodperson3.x = windowWidth;
                    ...
                    if(goodperson6.isTouching(greenLine)   ){
                      //  goodperson3.x = windowWidth;
                        goodperson6.x = windowWidth-2000;
                        gpr_Sound.play();
                        t6.visible = true;
                        }
 ...
 cov.visible = true;
  ...
  if(mousePressedOver(ll5)||touches.length>0){
    touches = [];
    back2.y = windowHeight-20690;
    back2.visible = false;
    swal(
  ...
  */
  ...
  if(mousePressedOver(back)||touches.length>0){
    ...
    covid_ball2.velocityX = 0;
    covid_ball3.velocityX = 0;   
    covid_ball1.x = windowWidth+200;
    covid_ball2.x =  windowWidth+200;
    covid_ball3.x =  windowWidth+200; 
...
if(mousePressedOver(htp)|| touches.length>0){
 ...
 back2.visible = true;
  ...
  if(goodperson1.x<windowWidth-1500 && goodperson2.x<windowWidth-1500 && goodperson3.x<windowWidth-1500 &&  goodperson4.x<windowWidth-1500 && goodperson5.x<windowWidth-1500 && goodperson6.x<windowWidth-1500 )
  gameState = END5;
...
function goodpersonx(){
  if(frameCount % 160 ===0){
    goodperson1 = createSprite(windowWidth ,windowHeight-662,30,70);
  goodperson1.addImage(goodperson_Image);
  goodperson1.scale = 0.3;
  goodperson1.velocityX = -8;
  //goodperson1.visible = false;
//goodperson1.lifeTime = windowWidth-200;
